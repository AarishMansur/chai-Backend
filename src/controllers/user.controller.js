...
const getUserChannelProfile = asyncHandler(async (req,res)=>{
 ...
 const channel = await  Users.aggregate([
   ...
   },
   {
      ...
      $addFields:{
         subscriberCount:{
            $size:"$subscribers" // to count all documents
         },
...
export {registerUser,UserLoggedIn,UserLogOut,refreshAccessToken,getCurrentUser,changeCurrentPassword,updateAccountDetails,updateUserAvatar,updateUserCoverImage,getUserChannelProfile,getWatchHistory}